    ...
    <Shell>
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div className="grid-4">
          {[
            { label: "Total IOCs", value: indicators.length, color: "#06b6d4", delay: 0 },
            { label: "Critical", value: indicators.filter((i) => i.severity === "critical").length, color: "#ef4444", delay: 0.1 },
            { label: "High", value: indicators.filter((i) => i.severity === "high").length, color: "#f97316", delay: 0.2 },
            { label: "TLP:Red", value: indicators.filter((i) => i.tlp === "red").length, color: "#ef4444", delay: 0.3 },
          ].map((stat) => (
            <motion.div
              key={stat.label}
        ...
        <motion.div
          ...
          style={{ padding: 16, display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }}
        >
