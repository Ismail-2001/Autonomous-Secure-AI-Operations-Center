    ...
    <Shell>
      <div style={{ display: "flex", flexDirection: "column", gap: 20, animation: "fade-in 0.4s ease" }}>
        ...
        <div className="glass-panel" style={{ padding: 16, display: "flex", gap: 12, alignItems: "center" }}>
          ...
          <button onClick={fetchEvents} className="btn-primary btn-sm">
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <svg
                    ...
                    style={{ transform: expanded === evt.id ? "rotate(180deg)" : "rotate(0)", transition: "transform 0.2s ease", flexShrink: 0 }}
                  >
