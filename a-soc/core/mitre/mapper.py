...
class MitreMapper:
    CLOUD_EVENT_MAP: Dict[str, Tuple[str, str, str, str]] = {
        ...
        "CreateAccessKey": (
            ...
            "Persistence",
            "Adversary may manipulate accounts to maintain access",
        ),
        "AssumeRole": (
            "T1524",
            "Cloud Infrastructure Discovery",
            "Discovery",
            "Adversary may assume a role to discover cloud resources",
        ),
        ...
        "AttachRolePolicy": (
            ...
            "Account Manipulation",
            "Privilege Escalation",
            "Adversary may attach policies to escalate privileges",
        ),
        "PutRolePolicy": (
            "T1098",
            "Account Manipulation",
            "Privilege Escalation",
            "Adversary may modify role policies",
        ),
        "CreatePolicy": (
            "T1098",
            "Account Manipulation",
            "Privilege Escalation",
            "Custom policy creation for privilege escalation",
        ),
        "UpdateAssumeRolePolicy": (
            "T1524",
            "Cloud Infrastructure Discovery",
            "Privilege Escalation",
            "Modifying trust policies for cross-account access",
        ),
        # Defense Evasion
        "DeleteTrail": (
            "T1562",
        ...
        "UpdateTrail": (
            ...
            "Impair Defenses",
            "Defense Evasion",
            "Modifying trail configuration to evade detection",
        ),
        "DeleteFlowLogs": (
            "T1562",
            "Impair Defenses",
            "Defense Evasion",
            "Removing VPC flow logs to hide network activity",
        ),
        "DisableAlarm": (
            "T1562",
            "Impair Defenses",
            "Defense Evasion",
            "Disabling CloudWatch alarms to avoid detection",
        ),
        "PutBucketPolicy": (
            "T1525",
            "Cloud Service Discovery",
            "Defense Evasion",
            "Modifying bucket policies for data access",
        ),
        # Credential Access
        "GetSecretValue": (
            "T1552",
            ...
            "Credential Access",
            "Accessing secrets stored in Secrets Manager",
        ),
        "ListSecrets": (
            "T1552",
            "Unsecured Credentials",
            "Credential Access",
            "Enumerating secrets for credential access",
        ),
        ...
        "DescribeInstances": (
            ...
            "Cloud Service Discovery",
            "Discovery",
            "Enumerating EC2 instances for targeting",
        ),
        "DescribeSecurityGroups": (
            "T1526",
            "Cloud Service Discovery",
            "Discovery",
            "Mapping security group rules for network access",
        ),
        ...
        "ListRoles": (
            ...
            "Cloud Service Discovery",
            "Discovery",
            "Enumerating IAM roles for privilege escalation",
        ),
        ...
        "GetObject": (
            ...
            "Exfiltration",
            "Accessing data stored in cloud object storage",
        ),
        ...
        "TerminateInstances": (
            ...
            "Data Destruction",
            "Impact",
            "Terminating EC2 instances for service disruption",
        ),
        ...
        "ModifyInstanceAttribute": (
            ...
            "Resource Hijacking",
            "Impact",
            "Modifying instance attributes for resource hijacking",
        ),
        "RunInstances": (
            "T1496",
            "Resource Hijacking",
            "Impact",
            "Launching instances for cryptomining or resource abuse",
        ),
        # Persistence
        "CreateLoginProfile": (
            "T1098",
            "Account Manipulation",
            "Persistence",
            "Creating console password for IAM user",
        ),
        ...
        "ModifyNetworkInterfaceAttribute": (
            ...
            "Remote Services",
            "Lateral Movement",
            "Modifying ENI for network pivoting",
        ),
        "AuthorizeSecurityGroupIngress": (
            "T1021",
            "Remote Services",
            "Lateral Movement",
            "Opening security groups for lateral movement",
        ),
        "RevokeSecurityGroupIngress": (
            "T1021",
            "Remote Services",
            "Lateral Movement",
            "Removing ingress rules to hinder forensics",
        ),
    }

    # Tactics commonly detected via generic event signals
    GENERIC_PATTERNS: List[Tuple[str, Tuple[str, str, str, str]]] = [
        (
            "brute force",
            ("T1110", "Brute Force", "Credential Access", "Repeated login attempts to compromise credentials"),
        ),
        ...
        (
            ...
            (
                ...
                "Privilege Escalation",
                "Exploiting vulnerability to gain elevated privileges",
            ),
        ),
